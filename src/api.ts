...
export const api = {
  getModels: (cli: AgentCli) => getJson<ModelOption[]>(`/api/models?cli=${encodeURIComponent(cli)}`),
  refreshModels: (cli: AgentCli) => sendJson<ModelOption[]>('/api/models/refresh', 'POST', { cli }),
